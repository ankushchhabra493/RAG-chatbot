...
func handleChat(w http.ResponseWriter, r *http.Request) {
	...
	if len(retrievedContexts) > 0 {
		promptBuilder.WriteString("You are a knowledgeable medical assistant. I'll provide you with some relevant medical context, but please use your comprehensive knowledge to provide a complete answer.\n\n")
